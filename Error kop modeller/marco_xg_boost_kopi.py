...
if "snr_db" not in df_analysis.columns or "beta" not in df_analysis.columns:
    ...
    if df_noise.empty:
        ...
        # Fejlrate vs SNR
        # ----------------------------
        # Afrund SNR til heltal (hvis det ikke allerede er det)
        ...
        # Gruppér direkte på hver SNR-værdi
        snr_error = df_noise.groupby("snr_int")["correct"].mean()
        snr_error = 1 - snr_error

        # Sørg for sortering og vis alle mellemliggende heltalsværdier
        snr_error = snr_error.sort_index()
        ...
        plt.tight_layout()
        plt.savefig("Modeller/XG boost/error_rate_vs_snr.png", dpi=300)
        plt.show()
        print("SNR-fejlplot gemt: Modeller/XG boost/error_rate_vs_snr.png")
        ...
        plt.tight_layout()
        plt.savefig("Modeller/XG boost/error_rate_vs_beta.png", dpi=300)
        plt.show()
        print("Beta-fejlplot gemt: Modeller/XG boost/error_rate_vs_beta.png")
